...
- **`charts/fintech/`** - 10 charts: stacked bar, market map, heatmap, funding-vs-revenue trajectory, cohort outcome split, market size projection, VC-vs-deals trend, and three stage breakdown views
