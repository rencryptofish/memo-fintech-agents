...
| Decision | [Final Synthesis Memo](memos/final-memo-agent-fintech-intersection-2026.md) | One-document view of agent ecosystem, fintech state, and best intersection startup opportunities |
...
- **`charts/intersection/`** - 5 charts: protocol launch timeline, protocol capability matrix, layer funding heatmap, agent-commerce readiness roadmap, and startup opportunity scorecard
